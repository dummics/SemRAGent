...
$Semragent = Join-Path $BinDir "semragent.cmd"
...
Set-Content -LiteralPath $Semragent -Encoding ASCII -Value "@echo off`r`n`"$CmdPython`" -m workspace_docs_mcp.cli %*`r`n"
...
Step "Final commands"
Write-Host "semragent:          $Semragent"
